    ...
    try{
        ...
        switch (main) {
            case 'Clouds':
              ...
              bgImage = `images/${weatherData.weather[0].icon.slice(-1) === 'n' ? 'night' : 'day'}/cloudy.jpg`;
              break;
            case 'Clear':
              weatherIcon = 'icons/clear.png';
              bgImage = `images/${weatherData.weather[0].icon.slice(-1) === 'n' ? 'night' : 'day'}/clear.jpg`;
              break;
            case 'Rain':
              weatherIcon = 'icons/rain.png';
              bgImage = `images/${weatherData.weather[0].icon.slice(-1) === 'n' ? 'night' : 'day'}/rainy.jpg`;
              break;
            case 'Drizzle':
            ...
            case 'Haze':
              ...
              bgImage = `images/${weatherData.weather[0].icon.slice(-1) === 'n' ? 'night' : 'day'}/haze.jpg`;
              break;
            default:
              break;
          }
